...
#define MODULES_AR_RELEASE_MINOR_VERSION_H      9
#define MODULES_AR_RELEASE_REVISION_VERSION_H   0
#define MODULES_SW_MAJOR_VERSION_H              7
...
/** 
* @brief This constant used for other modules to check if WDG Instance 22 is present in the project.   
*/
#define USE_WDG_INSTANCE22         (STD_OFF)

/** 
* @brief This constant used for other modules to check if WDG Instance 23 is present in the project.   
*/
#define USE_WDG_INSTANCE23         (STD_OFF)

/** 
* @brief This constant used for other modules to check if WDG Instance 24 is present in the project.   
*/
#define USE_WDG_INSTANCE24         (STD_OFF)

/** 
* @brief This constant used for other modules to check if WDG Instance 25 is present in the project.   
*/
#define USE_WDG_INSTANCE25         (STD_OFF)

/** 
* @brief This constant used for other modules to check if WDG Instance 26 is present in the project.   
*/
#define USE_WDG_INSTANCE26         (STD_OFF)
...
/** 
* @brief This constant used for other modules to check if WDG for chip fs04 is present in the project.   
*/
#define USE_WDG_43_FS04_MODULE      (STD_OFF)
/** 
