...
#define SOC_IPS_AR_RELEASE_MINOR_VERSION     9
#define SOC_IPS_AR_RELEASE_REVISION_VERSION  0
#define SOC_IPS_SW_MAJOR_VERSION             7
...
/**
* @brief Hardware errata for MCU: (ERR051739)
* @details ERR051739: Embedded Flash Memory: Module Control CTL[RWSC] is always greater than or equal to 3
*/
#define ERR_IPV_MCU_E051739         (STD_ON)
