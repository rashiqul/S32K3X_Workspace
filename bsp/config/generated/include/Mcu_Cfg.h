...
#define MCU_CFG_AR_RELEASE_MINOR_VERSION         9
#define MCU_CFG_AR_RELEASE_REVISION_VERSION      0
#define MCU_CFG_SW_MAJOR_VERSION                 7
...
*/
#define MCU_LASTMILE_SUPPORT        (STD_OFF)
...
#if (MCU_VERSION_INFO_API == STD_ON) || (MCU_GET_MIDR_API == STD_ON) || (MCU_PERFORM_RESET_API   == STD_ON)
...
#define MCU_E_ALREADY_INITIALIZED       ((uint8)0x13U)
    ...
    #define MCU_E_EMIOS_INDEX_OUT_OF_RANGE    ((uint8)0x23U)
...
*/
#define MCU_MULTIPARTITION_SUPPORT            (STD_OFF)
#if (STD_ON == MCU_MULTIPARTITION_SUPPORT)
    #define Mcu_GetPartitionID()     OsIf_GetUserId()
#else
    #define Mcu_GetPartitionID()     ((uint8)0UL)
#endif
/*==================================================================================================
*                                             ENUMS
==================================================================================================*/
