...
#define POWER_IP_AR_RELEASE_MINOR_VERSION_C       9
#define POWER_IP_AR_RELEASE_REVISION_VERSION_C    0
#define POWER_IP_SW_MAJOR_VERSION_C               7
#define POWER_IP_SW_MINOR_VERSION_C               0
#define POWER_IP_SW_PATCH_VERSION_C               1
...
/* Check if Power_Ip.c file and Power_Ip_DCM_GPR.h file are of the same vendor */
#if (POWER_IP_VENDOR_ID_C != POWER_IP_DCM_GPR_VENDOR_ID)
    #error "Power_Ip.c and Power_Ip_DCM_GPR.h have different vendor ids"
#endif

/* Check if Power_Ip.c file and Power_Ip_DCM_GPR.h file are of the same Autosar version */
#if ((POWER_IP_AR_RELEASE_MAJOR_VERSION_C != POWER_IP_DCM_GPR_AR_RELEASE_MAJOR_VERSION) || \
     (POWER_IP_AR_RELEASE_MINOR_VERSION_C != POWER_IP_DCM_GPR_AR_RELEASE_MINOR_VERSION) || \
     (POWER_IP_AR_RELEASE_REVISION_VERSION_C != POWER_IP_DCM_GPR_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Power_Ip.c and Power_Ip_DCM_GPR.h are different"
#endif

/* Check if Power_Ip.c file and Power_Ip_DCM_GPR.h file are of the same Software version */
#if ((POWER_IP_SW_MAJOR_VERSION_C != POWER_IP_DCM_GPR_SW_MAJOR_VERSION) || \
     (POWER_IP_SW_MINOR_VERSION_C != POWER_IP_DCM_GPR_SW_MINOR_VERSION) || \
     (POWER_IP_SW_PATCH_VERSION_C != POWER_IP_DCM_GPR_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Power_Ip.c and Power_Ip_DCM_GPR.h are different"
#endif

#ifdef POWER_IP_AECRESETCONFIG_API
#if (POWER_IP_AECRESETCONFIG_API == STD_ON)

/* Check if Power_Ip.c file and Power_Ip_AEC.h file are of the same vendor */
#if (POWER_IP_VENDOR_ID_C != POWER_IP_AEC_VENDOR_ID)
    #error "Power_Ip.c and Power_Ip_AEC.h have different vendor ids"
#endif

/* Check if Power_Ip.c file and Power_Ip_AEC.h file are of the same Autosar version */
#if ((POWER_IP_AR_RELEASE_MAJOR_VERSION_C != POWER_IP_AEC_AR_RELEASE_MAJOR_VERSION) || \
     (POWER_IP_AR_RELEASE_MINOR_VERSION_C != POWER_IP_AEC_AR_RELEASE_MINOR_VERSION) || \
     (POWER_IP_AR_RELEASE_REVISION_VERSION_C != POWER_IP_AEC_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Power_Ip.c and Power_Ip_AEC.h are different"
#endif

/* Check if Power_Ip.c file and Power_Ip_AEC.h file are of the same Software version */
#if ((POWER_IP_SW_MAJOR_VERSION_C != POWER_IP_AEC_SW_MAJOR_VERSION) || \
     (POWER_IP_SW_MINOR_VERSION_C != POWER_IP_AEC_SW_MINOR_VERSION) || \
     (POWER_IP_SW_PATCH_VERSION_C != POWER_IP_AEC_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Power_Ip.c and Power_Ip_AEC.h are different"
#endif
...
static void Power_Ip_PrepareSocStandby(const Power_Ip_ModeConfigType * ModeConfigPtr)
{
#ifdef ERR_IPV_PMC_E051494
  #if (STD_ON == ERR_IPV_PMC_E051494)
    Power_Ip_PMC_DisableLDO();
  #endif
#endif
...
Power_Ip_PowerModeType Power_Ip_GetPreviousMode(void)
{
    ...
    {
        PowerPrevMode = POWER_IP_SOC_STANDBY_MODE;
    }
    else
    {
  #endif
...
/**
* @brief            This function returns the reset raw value.
* @details          This routine returns the Reset Raw Value that is read from the hardware.
*                   Called by:
*                       - Mcu_GetResetRawValue() from HLD.
*
* @param[in]        None
*
* @return           void
