...
#define RAM_IP_AR_RELEASE_MINOR_VERSION_C       9
#define RAM_IP_AR_RELEASE_REVISION_VERSION_C    0
#define RAM_IP_SW_MAJOR_VERSION_C               7
#define RAM_IP_SW_MINOR_VERSION_C               0
#define RAM_IP_SW_PATCH_VERSION_C               1
...
void Ram_Ip_SetUserAccessAllowed(void)
{
...
Ram_Ip_StatusType Ram_Ip_InitRamSection(const Ram_Ip_RamConfigType * RamConfigPtr)
{
    ...
    RamCounter = (Ram_Ip_RamIndexType)0U;
    while ((RamCounter < RamCounterLimit) && (RAM_IP_STATUS_OK == RamStatus))
    {
        switch (RamConfigPtr->RamWriteSize)
        {
            case (Ram_Ip_RamWriteSizeType)1U:
                ...
                ( *((uint8 (*)[]) ((Ram_Ip_uintPtrType) RamConfigPtr->RamBaseAddrPtr)) )[RamCounter]  = (uint8) (RamConfigPtr->RamDefaultValue);
                break;

            case (Ram_Ip_RamWriteSizeType)2U:

                ( *((uint16 (*)[]) ((Ram_Ip_uintPtrType) RamConfigPtr->RamBaseAddrPtr)) )[RamCounter] = (uint16) ( ((uint16)(RamConfigPtr->RamDefaultValue) << 0U) | ((uint16)(RamConfigPtr->RamDefaultValue) << 8U) );
                break;

            case (Ram_Ip_RamWriteSizeType)4U:

                ( *((uint32 (*)[]) ((Ram_Ip_uintPtrType) RamConfigPtr->RamBaseAddrPtr)) )[RamCounter] = \
            ...
            case (Ram_Ip_RamWriteSizeType)8U:
                ...
                ( *((uint64 (*)[]) ((Ram_Ip_uintPtrType) RamConfigPtr->RamBaseAddrPtr)) )[RamCounter] = \
    ...
    while ((RamCounter < RamCounterLimit) && (RAM_IP_STATUS_OK == RamStatus))
    {
        switch (RamConfigPtr->RamWriteSize)
        {
            case (Ram_Ip_RamWriteSizeType)1U:
                ...
                if ( (uint8) (RamConfigPtr->RamDefaultValue)  != ( *((uint8 (*)[]) ((Ram_Ip_uintPtrType)RamConfigPtr->RamBaseAddrPtr)) )[RamCounter] )
                {
                    RamStatus = RAM_IP_STATUS_NOT_OK;
                }
                break;
            ...
            case (Ram_Ip_RamWriteSizeType)2U:
                ...
                if ( (uint16) ( ((uint16)(RamConfigPtr->RamDefaultValue) << 0U) | ((uint16)(RamConfigPtr->RamDefaultValue) << 8U) ) != ( *((uint16 (*)[]) ((Ram_Ip_uintPtrType)RamConfigPtr->RamBaseAddrPtr)) )[RamCounter] )
                {
                    RamStatus = RAM_IP_STATUS_NOT_OK;
                }
                break;
...
#if (defined(RAM_IP_ENABLE_USER_MODE_SUPPORT) && (STD_ON == RAM_IP_ENABLE_USER_MODE_SUPPORT))
    OsIf_Trusted_Call(Ram_Ip_SetUserAccessAllowed);
#endif
