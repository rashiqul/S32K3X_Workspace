...
#define POWER_IP_PMC_TYPES_AR_RELEASE_MINOR_VERSION        9
#define POWER_IP_PMC_TYPES_AR_RELEASE_REVISION_VERSION     0
#define POWER_IP_PMC_TYPES_SW_MAJOR_VERSION                7
#define POWER_IP_PMC_TYPES_SW_MINOR_VERSION                0
#define POWER_IP_PMC_TYPES_SW_PATCH_VERSION                1
...
#define PMC_LVSC_RESET_FLAGS_RWBITS_MASK32              ((uint32)0xFFFF0000U)
#define PMC_LVSC_OV_UV_IRQ_FLAGS_MASK32                 ((uint32)0x000000DFU)

#define PMC_LVSC_UV_IRQ_FLAGS_MASK32                    ((uint32)0x00000090U)
#define PMC_LVSC_OV_IRQ_FLAGS_MASK32                    ((uint32)0x0000004FU)

#define PMC_LVSC_RWBITS_MASK32                          ((uint32)0xFFFF00DFU)
#define PMC_LVSC_RESET_MASK32                           ((uint32)0x00001000U)
#define PMC_LVSC_RESERVED_MASK32                        ((uint32)( (uint32)(~PMC_LVSC_RWBITS_MASK32) & PMC_LVSC_RESET_MASK32 ))
...
#define PMC_CONFIG_LMSMPSEN_ENABLE              ((uint32)PMC_CONFIG_LMSMPSEN_MASK)
#define PMC_CONFIG_LMSMPSEN_DISABLE             ((uint32)0x00000000U)

#define PMC_CONFIG_LVRBLP_ENABLE                ((uint32)PMC_CONFIG_LVRBLPEN_MASK)
#define PMC_CONFIG_LVRBLP_DISABLE               ((uint32)0x00000000U)

#elif defined(POWER_IP_DERIVATIVE_008) || defined(POWER_IP_DERIVATIVE_009) || defined(POWER_IP_DERIVATIVE_010)
/***********************************************************/
/*                        PMC_LVSC                         */
/***********************************************************/

#define PMC_LVSC_RAMP_UP_RESET_FLAGS_RWBITS_MASK32      ((uint32)0x80FF0000U)
#define PMC_LVSC_RESET_FLAGS_RWBITS_MASK32              ((uint32)0x8FFF0000U)
#define PMC_LVSC_OV_UV_IRQ_FLAGS_MASK32                 ((uint32)0x0000005FU)

#define PMC_LVSC_UV_IRQ_FLAGS_MASK32                    ((uint32)0x00000010U)
#define PMC_LVSC_OV_IRQ_FLAGS_MASK32                    ((uint32)0x0000004FU)

#define PMC_LVSC_RWBITS_MASK32                          ((uint32)0x8FFF005FU)
#define PMC_LVSC_RESET_MASK32                           ((uint32)0x00001000U)
#define PMC_LVSC_RESERVED_MASK32                        ((uint32)( (uint32)(~PMC_LVSC_RWBITS_MASK32) & PMC_LVSC_RESET_MASK32 ))
