...
#define POWER_IP_MC_ME_AR_RELEASE_MINOR_VERSION        9
#define POWER_IP_MC_ME_AR_RELEASE_REVISION_VERSION     0
#define POWER_IP_MC_ME_SW_MAJOR_VERSION                7
#define POWER_IP_MC_ME_SW_MINOR_VERSION                0
#define POWER_IP_MC_ME_SW_PATCH_VERSION                1
...
/* Check if source file and Std_Types.h file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Power_Ip_MC_ME.h and Std_Types.h are different"
#endif
