...
#define RAM_IP_TYPES_AR_RELEASE_MINOR_VERSION      9
#define RAM_IP_TYPES_AR_RELEASE_REVISION_VERSION   0
#define RAM_IP_TYPES_SW_MAJOR_VERSION              7
#define RAM_IP_TYPES_SW_MINOR_VERSION              0
#define RAM_IP_TYPES_SW_PATCH_VERSION              1
...
typedef struct
{
#if defined(RAM_IP_MULTIPARTITION_SUPPORT)
#if (RAM_IP_MULTIPARTITION_SUPPORT == STD_ON)
    uint8 RamPartitionId;                    /**< @brief The ID for Partition. */
#endif
#endif
    Ram_Ip_RamSectionType RamSectorId;       /**< @brief The ID for Ram Sector configuration.  */
    uint8 (*RamBaseAddrPtr)[];               /**< @brief RAM section base address.             */
