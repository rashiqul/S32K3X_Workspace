...
#define POWER_IP_TYPES_AR_RELEASE_MINOR_VERSION        9
#define POWER_IP_TYPES_AR_RELEASE_REVISION_VERSION     0
#define POWER_IP_TYPES_SW_MAJOR_VERSION                7
#define POWER_IP_TYPES_SW_MINOR_VERSION                0
#define POWER_IP_TYPES_SW_PATCH_VERSION                1
...
typedef struct
{
#if defined(POWER_IP_MULTIPARTITION_SUPPORT)
#if (POWER_IP_MULTIPARTITION_SUPPORT == STD_ON)
    /**< @brief The ID for Partition. */
    uint8 PowerPartitionId;
#endif
#endif
