...
#define POWER_IP_SPECIFIC_AR_RELEASE_MINOR_VERSION        9
#define POWER_IP_SPECIFIC_AR_RELEASE_REVISION_VERSION     0
#define POWER_IP_SPECIFIC_SW_MAJOR_VERSION                7
#define POWER_IP_SPECIFIC_SW_MINOR_VERSION                0
#define POWER_IP_SPECIFIC_SW_PATCH_VERSION                1
...
#if (!(defined(POWER_IP_DERIVATIVE_006) || defined(POWER_IP_DERIVATIVE_008) || defined(POWER_IP_DERIVATIVE_009) || defined(POWER_IP_DERIVATIVE_010)))
...
#if (!(defined(POWER_IP_DERIVATIVE_008) || defined(POWER_IP_DERIVATIVE_010)))
...
#if (!(defined(POWER_IP_DERIVATIVE_006) || defined(POWER_IP_DERIVATIVE_008) || defined(POWER_IP_DERIVATIVE_010)))
...
#elif defined(POWER_IP_DERIVATIVE_009) || defined(POWER_IP_DERIVATIVE_008) || defined(POWER_IP_DERIVATIVE_010)
#define PMC_LVSC_RAMP_UP_RESET_FLAGS_RWBITS_MASK    (((uint32)PMC_LVSC_PORF_MASK | \
                                                      (uint32)PMC_LVSC_LVR11LPF_MASK | \
                                                      (uint32)PMC_LVSC_LVR11F_MASK | \
                                                      (uint32)PMC_LVSC_LVR25LPF_MASK | \
