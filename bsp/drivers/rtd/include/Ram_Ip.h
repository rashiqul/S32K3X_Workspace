...
#define RAM_IP_AR_RELEASE_MINOR_VERSION      9
#define RAM_IP_AR_RELEASE_REVISION_VERSION   0
#define RAM_IP_SW_MAJOR_VERSION              7
#define RAM_IP_SW_MINOR_VERSION              0
#define RAM_IP_SW_PATCH_VERSION              1
...
#endif
/* Check if Ram_Ip.h file and Mcal.h file are of the same Autosar version */
#if ((RAM_IP_AR_RELEASE_MAJOR_VERSION    != MCAL_AR_RELEASE_MAJOR_VERSION) || \
     (RAM_IP_AR_RELEASE_MINOR_VERSION    != MCAL_AR_RELEASE_MINOR_VERSION))
    #error "AutoSar Version Numbers of Ram_Ip.h and Mcal.h are different"
#endif
#endif
