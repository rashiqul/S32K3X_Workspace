...
#include "Ram_Ip_TrustedFunctions.h"
...
#define MCU_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION      9
#define MCU_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION   0
#define MCU_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION              7
#define MCU_TRUSTEDFUNCTIONS_SW_MINOR_VERSION              0
#define MCU_TRUSTEDFUNCTIONS_SW_PATCH_VERSION              1
...
/* Check if Mcu_TrustedFunctions.h file and Ram_Ip_TrustedFunctions.h file are of the same vendor */
#if (MCU_TRUSTEDFUNCTIONS_VENDOR_ID != RAM_IP_TRUSTEDFUNCTIONS_VENDOR_ID)
    #error "Mcu_TrustedFunctions.h and Ram_Ip_TrustedFunctions.h have different vendor ids"
#endif

/* Check if Mcu_TrustedFunctions.h file and Ram_Ip_TrustedFunctions.h file are of the same Autosar version */
#if ((MCU_TRUSTEDFUNCTIONS_AR_RELEASE_MAJOR_VERSION != RAM_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MAJOR_VERSION) || \
     (MCU_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION != RAM_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION) || \
     (MCU_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION != RAM_IP_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Mcu_TrustedFunctions.h and Ram_Ip_TrustedFunctions.h are different"
#endif

/* Check if Mcu_TrustedFunctions.h file and Ram_Ip_TrustedFunctions.h file are of the same Software version */
#if ((MCU_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION != RAM_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION) || \
     (MCU_TRUSTEDFUNCTIONS_SW_MINOR_VERSION != RAM_IP_TRUSTEDFUNCTIONS_SW_MINOR_VERSION) || \
     (MCU_TRUSTEDFUNCTIONS_SW_PATCH_VERSION != RAM_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mcu_TrustedFunctions.h and Ram_Ip_TrustedFunctions.h are different"
#endif
/*==================================================================================================
                                           CONSTANTS
==================================================================================================*/
